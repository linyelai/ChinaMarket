    ...
    <el-container>
        ...
        <div class="nav">
          <ul>
            <li v-if="!this.$store.getters.getUser">
              <el-button type="text" @click="login">Sign in</el-button>
              <span class="sep">|</span>
            ...
            <li :class="getNum > 0 ? 'shopCart-full' : 'shopCart'">
              <router-link to="/shoppingCart">
                <i class="el-icon-shopping-cart-full"></i> Shop Car
      ...
      <el-header>
        ...
        >
          ...
          <el-menu-item index="/goods">All Product</el-menu-item>
          <el-menu-item index="/seckill">SecKill</el-menu-item>
        ...
        <div class="footer">
          ...
          <div class="mod_help">
            <p>
              ...
              <span>|</span>
              <router-link to="/goods">All Product</router-link>
              <span>|</span>
              <router-link to="/seckill">SecKill</router-link>
              <span>|</span>
